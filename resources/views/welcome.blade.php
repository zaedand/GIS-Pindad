...
<header class="py-4 px-4 lg:px-8 border-b border-gray-200 shadow-lg  relative">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        <div class="flex items-center">
            ...
            <h1 class="text-xl md:text-2xl font-bold text-corporate">Internal<span class="text-primary">Phone</span>Monitor</h1>
        </div>
...
<section class="py-12 px-4 lg:px-8">
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
            ...
            <p class="text-gray-600 mb-6 max-w-xl">Pantau status telepon PBX seluruh lokasi perusahaan secara real-time. Sistem ini hanya dapat diakses oleh admin dan teknisi resmi.</p>
...
<footer class="py-8 px-4 lg:px-8 bg-gray-900 text-gray-300">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <div class="flex items-center">
            ...
            <h1 class="text-xl font-semibold text-white">Internal<span class="text-primary">Phone</span>Monitor</h1>
        </div>
